...
public:
    ...
    bool save(std::vector<calque> _calques, bool dataReady, const std::vector<Resultat> & resultats, int row, int col, calque res);
    void saveCurrentDisplay(std::string savePath, std::string currentDisplayPath);
    void save_as(std::string path, std::string fileName, std::vector<calque> _calques, bool dataReady, std::vector<Resultat> resultats, int row, int col, calque res);
