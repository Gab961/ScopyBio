...
set(CONAN_EIGEN3_ROOT "/home/etudiant/.conan/data/eigen/3.3.7/conan/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_EIGEN3 "/home/etudiant/.conan/data/eigen/3.3.7/conan/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/eigen3")
set(CONAN_LIB_DIRS_EIGEN3 )
set(CONAN_BIN_DIRS_EIGEN3 )
set(CONAN_RES_DIRS_EIGEN3 )
set(CONAN_SRC_DIRS_EIGEN3 )
set(CONAN_BUILD_DIRS_EIGEN3 "/home/etudiant/.conan/data/eigen/3.3.7/conan/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_OPENCV}" "${CONAN_LIB_DIRS_OPENCV}"
                                  CONAN_PACKAGE_TARGETS_OPENCV "CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3" "" opencv)
    conan_package_library_targets("${CONAN_LIBS_OPENCV_DEBUG}" "${CONAN_LIB_DIRS_OPENCV_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_OPENCV_DEBUG "CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3" "debug" opencv)
    conan_package_library_targets("${CONAN_LIBS_OPENCV_RELEASE}" "${CONAN_LIB_DIRS_OPENCV_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_OPENCV_RELEASE "CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3" "release" opencv)
    conan_package_library_targets("${CONAN_LIBS_OPENCV_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_OPENCV_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_OPENCV_RELWITHDEBINFO "CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3" "relwithdebinfo" opencv)
    conan_package_library_targets("${CONAN_LIBS_OPENCV_MINSIZEREL}" "${CONAN_LIB_DIRS_OPENCV_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_OPENCV_MINSIZEREL "CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3" "minsizerel" opencv)
    ...
    set_property(TARGET CONAN_PKG::opencv PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_OPENCV} ${CONAN_SHARED_LINKER_FLAGS_OPENCV_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENCV_LIST}
                                                                 ...
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_OPENCV_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_OPENCV_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENCV_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_OPENCV_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_OPENCV_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENCV_MINSIZEREL_LIST}>
                                                                 ...
                                                                 CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3)
    ...
    conan_package_library_targets("${CONAN_LIBS_JASPER_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_JASPER_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_JASPER_RELWITHDEBINFO "CONAN_PKG::libjpeg" "relwithdebinfo" jasper)
    conan_package_library_targets("${CONAN_LIBS_JASPER_MINSIZEREL}" "${CONAN_LIB_DIRS_JASPER_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_JASPER_MINSIZEREL "CONAN_PKG::libjpeg" "minsizerel" jasper)
    ...
    set_property(TARGET CONAN_PKG::jasper PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_JASPER} ${CONAN_SHARED_LINKER_FLAGS_JASPER_LIST} ${CONAN_EXE_LINKER_FLAGS_JASPER_LIST}
                                                                 ...
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_JASPER_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_JASPER_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_JASPER_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_JASPER_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_JASPER_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_JASPER_MINSIZEREL_LIST}>
    ...
    conan_package_library_targets("${CONAN_LIBS_OPENEXR_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_OPENEXR_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_OPENEXR_RELWITHDEBINFO "CONAN_PKG::zlib" "relwithdebinfo" openexr)
    conan_package_library_targets("${CONAN_LIBS_OPENEXR_MINSIZEREL}" "${CONAN_LIB_DIRS_OPENEXR_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_OPENEXR_MINSIZEREL "CONAN_PKG::zlib" "minsizerel" openexr)
    ...
    set_property(TARGET CONAN_PKG::openexr PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_OPENEXR} ${CONAN_SHARED_LINKER_FLAGS_OPENEXR_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENEXR_LIST}
                                                                 ...
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_OPENEXR_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_OPENEXR_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENEXR_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_OPENEXR_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_OPENEXR_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_OPENEXR_MINSIZEREL_LIST}>
    ...
    conan_package_library_targets("${CONAN_LIBS_PROTOBUF_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_PROTOBUF_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_PROTOBUF_RELWITHDEBINFO "" "relwithdebinfo" protobuf)
    conan_package_library_targets("${CONAN_LIBS_PROTOBUF_MINSIZEREL}" "${CONAN_LIB_DIRS_PROTOBUF_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_PROTOBUF_MINSIZEREL "" "minsizerel" protobuf)
    ...
    conan_package_library_targets("${CONAN_LIBS_EIGEN3}" "${CONAN_LIB_DIRS_EIGEN3}"
                                  CONAN_PACKAGE_TARGETS_EIGEN3 "" "" Eigen3)
    conan_package_library_targets("${CONAN_LIBS_EIGEN3_DEBUG}" "${CONAN_LIB_DIRS_EIGEN3_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_EIGEN3_DEBUG "" "debug" Eigen3)
    conan_package_library_targets("${CONAN_LIBS_EIGEN3_RELEASE}" "${CONAN_LIB_DIRS_EIGEN3_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_EIGEN3_RELEASE "" "release" Eigen3)
    conan_package_library_targets("${CONAN_LIBS_EIGEN3_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_EIGEN3_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_EIGEN3_RELWITHDEBINFO "" "relwithdebinfo" Eigen3)
    conan_package_library_targets("${CONAN_LIBS_EIGEN3_MINSIZEREL}" "${CONAN_LIB_DIRS_EIGEN3_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_EIGEN3_MINSIZEREL "" "minsizerel" Eigen3)
    ...
    conan_package_library_targets("${CONAN_LIBS_LIBJPEG_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_LIBJPEG_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_LIBJPEG_RELWITHDEBINFO "" "relwithdebinfo" libjpeg)
    conan_package_library_targets("${CONAN_LIBS_LIBJPEG_MINSIZEREL}" "${CONAN_LIB_DIRS_LIBJPEG_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_LIBJPEG_MINSIZEREL "" "minsizerel" libjpeg)
    ...
    set(CONAN_TARGETS CONAN_PKG::opencv CONAN_PKG::libtiff CONAN_PKG::libwebp CONAN_PKG::libpng CONAN_PKG::jasper CONAN_PKG::openexr CONAN_PKG::protobuf CONAN_PKG::Eigen3 CONAN_PKG::zlib CONAN_PKG::libjpeg)
